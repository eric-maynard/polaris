...
/**
 * Default implementation of the PolarisPrincipalsApiService. Provides default
...
public class PolarisPrincipalsApiServiceImpl implements PolarisPrincipalsApiService {
  public Response assignPrincipalRole(String principalName,GrantPrincipalRoleRequest grantPrincipalRoleRequest,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  public Response createPrincipal(CreatePrincipalRequest createPrincipalRequest,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  ...
  public Response listPrincipalRolesAssigned(String principalName,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  public Response listPrincipals(SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  public Response revokePrincipalRole(String principalName,String principalRoleName,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  public Response rotateCredentials(String principalName,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
  public Response updatePrincipal(String principalName,UpdatePrincipalRequest updatePrincipalRequest,SecurityContext securityContext) {
    return Response.status(501).build(); // not implemented
  }
}
