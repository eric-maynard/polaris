...
class TableGrant(GrantResource):
    """
    TableGrant
    """ # noqa: E501
    namespace: List[StrictStr]
    table_name: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(alias="tableName")
    privilege: TablePrivilege
    __properties: ClassVar[List[str]] = ["type", "namespace", "tableName", "privilege"]
